...
project = 'molecool'
copyright = ("2021, Jessica Nash. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for analyzing and visualzing molecular files. For molssi workshop.',
     'Miscellaneous'),
]
